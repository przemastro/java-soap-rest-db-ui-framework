...
import com.company.qa.elements.CommonPageElements;
import com.company.qa.utils.Configuration;
import com.company.qa.utils.SeleniumUtil;
...
public class CommonPage extends CommonPageElements {
    ...
    protected void waitForSpinners() {
        ...
        driver.manage().timeouts().implicitlyWait(Configuration.DEFAULT_WAIT_TIME, TimeUnit.SECONDS);
